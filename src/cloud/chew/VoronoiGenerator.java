...
public class VoronoiGenerator {
	...
	public double noise(double x, double z, double frequency, double amplitude, double frequency2) {
	    double v = voronoi.noise(x, z, frequency2);
	    double s = (simplex.noise(x, z, frequency, amplitude)+1)/2;
	    double p = Math.pow(v, Math.E);
	    return (p*v + (1-p) * s)/2;
	}
